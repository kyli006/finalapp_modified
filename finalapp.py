...
st.write("check out my Github [link](https://github.com/kyli006)")
st.write("The interesting dataset and the coding part about tokenizing string to numeric values refer to the author in [link](https://www.kaggle.com/bayunova/is-this-sentence-completed)")
st.write("Special thanks to the author for giving out such an interesting dataset and share the idea about processing such data.")
